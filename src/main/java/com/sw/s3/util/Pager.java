...
public class Pager {
	...
	//rowNum 계산하는 메서드
	public void makeRow() {	//this는 지역변수나 매개변수와 구별하기 위해 쓰는것이므로 지금은 안써도됨
